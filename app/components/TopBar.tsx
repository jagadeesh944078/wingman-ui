      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2  p-1 rounded-full">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-3 rounded-full text-[18px] font-medium ${
              pathname === "/"
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full text-[18px] font-medium ${
              pathname === "/sales"
                ? "bg-[#CCFBEF] shadow-sm text-gray-900"
                : "text-gray-500 hover:text-gray-700"
            }`}
